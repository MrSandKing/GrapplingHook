...
import me.mrsandking.grapplinghook.api.util.ConsoleUtil;
...
public abstract class BaseCommand extends Command {
    ...
    public void registerCommand(String command, Class<? extends ArgumentCommand> clazz) {
        try {
            ...
            ConsoleUtil.sendPrefixPluginMessage("&6[Grappling Hook]", "Something went wrong while registering argument '" + command + "'!");
            ConsoleUtil.sendPrefixPluginMessage("&6[Grappling Hook]", "Exception message: " + e.getMessage());
        }
    }
