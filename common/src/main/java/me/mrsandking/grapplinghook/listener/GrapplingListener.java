...
public final class GrapplingListener implements Listener {
    ...
    public void onFishEvent(PlayerFishEvent event) {
        ...
        GrapplingHook grapplingHook = GrapplingHookApi.getInstance().getGrapplingHookInjector().getGrapplingHook(player.getItemInHand());
        ...
        if (GrapplingHookMain.getInstance().getGrapplingHookManager().hasCooldown(player.getUniqueId())) {
            ...
            final long seconds = GrapplingHookApi.getInstance().getGrapplingHookManager().getCooldown(player.getUniqueId());
